...
import com.example.yoelfebryan.yoel_1202150036_studycase5.DatabaseHandler;
...
import com.example.yoelfebryan.yoel_1202150036_studycase5.RecyclerAdapter;
import com.example.yoelfebryan.yoel_1202150036_studycase5.SwipeHelper;
...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            ...
            dialog.setContentView(R.layout.custom_toolbar);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == 1){
            ...
            databaseHandler.save(new Activity(data.getStringExtra("activity"), data.getStringExtra("desc"), data.getStringExtra("priority")));
        }
        setRecyclerView();
